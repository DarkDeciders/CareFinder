...
export default function Careers() {
  ...
  const openPositions = [
    {
      ...
      type: "Full-time",
      description:
        "Ensure the highest standards of elderly care by conducting caregiver assessments, training programs, and quality monitoring across our platform.",
      requirements: [
    ...
    },
    {
      ...
      type: "Full-time",
      description:
        "Coordinate care plans, conduct health assessments, and provide clinical guidance to families and caregivers for optimal elderly care outcomes.",
      requirements: [
    ...
    },
    {
      ...
      type: "Full-time",
      description:
        "Develop and deliver comprehensive training programs for caregivers specializing in elderly care, dementia care, and mobility assistance.",
      requirements: [
    ...
    },
    {
      ...
      type: "Full-time",
      description:
        "Provide emotional support and guidance to families navigating elderly care decisions, connecting them with appropriate resources and services.",
      requirements: [
    ...
    },
    {
      ...
      type: "Full-time",
      description:
        "Build partnerships with hospitals, clinics, and healthcare providers to expand our elderly care network across Sri Lanka.",
      requirements: [
    ...
    },
    {
      ...
      type: "Full-time",
      description:
        "Provide expert consultation on elderly care needs, develop care protocols, and support families with complex geriatric health conditions.",
      requirements: [
  ...
  const benefits = [
    {
      ...
      description:
        "Market-competitive salaries with performance-based bonuses and equity options for senior roles.",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Comprehensive health insurance, annual health checkups, and mental wellness support programs.",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Annual learning budget, conference attendance, professional certifications, and skill development programs.",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Flexible working hours, remote work options, generous vacation policy, and family-friendly policies.",
    },
    {
      icon: (
        <svg
      ...
      title: "Team Culture",
      description:
        "Collaborative environment, team outings, innovation time, and opportunities to make meaningful impact.",
    },
    {
      icon: (
        <svg
      ...
      title: "Career Growth",
      description:
        "Clear advancement paths, mentorship programs, leadership opportunities, and cross-functional experience.",
    },
  ];
  ...
  return (
    <div className="min-h-screen transition-colors duration-300">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            ...
            <p className="mt-6 text-xl text-gray-600 dark:text-gray-300 mx-auto max-w-3xl leading-relaxed">
              Help us transform elderly care in Sri Lanka. Build meaningful
              healthcare solutions, create lasting impact in seniors&apos;
              lives, and be part of a team that&apos;s revolutionizing how
              families provide compassionate care for their aging loved ones.
            </p>
            <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="#open-positions"
                className="group bg-gradient-to-r from-primary-600 to-primary-700 hover:from-primary-700 hover:to-primary-800 text-white px-8 py-4 rounded-xl text-lg font-semibold transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 text-center"
              >
                View Open Positions
                <svg
              ...
              <Link
                href="/about"
                className="border-2 border-primary-600 dark:border-primary-400 text-primary-600 dark:text-primary-400 hover:bg-primary-50 dark:hover:bg-primary-900/20 px-8 py-4 rounded-xl text-lg font-semibold transition-all duration-300 text-center"
              >
                Learn About Us
              </Link>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Join a purpose-driven team that&apos;s making a real difference in
              people&apos;s lives
            </p>
          </div>
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center mb-16">
            <div>
              ...
              <div className="space-y-6 text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                <p>
                  Every assessment you conduct, every training program you
                  develop, and every family you support directly impacts the
                  quality of life for elderly individuals across Sri Lanka.
                  You&apos;re not just building a business—you&apos;re creating
                  a compassionate care ecosystem that honors our elders.
                </p>
                <p>
                  Our platform has already connected over 5,000 families with
                  qualified elderly care specialists, ensuring dignity, comfort,
                  and professional care for seniors in their own homes. Be part
                  of a team that&apos;s transforming how Sri Lankan society
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {benefits.map((benefit, index) => (
              <div
                key={index}
                className="group bg-white/70 dark:bg-gray-800/70 rounded-2xl p-8 shadow-soft hover:shadow-soft-lg dark:shadow-lg dark:hover:shadow-2xl transition-all duration-300 border border-gray-100/50 dark:border-gray-700/50"
              >
      ...
      <section
        id="open-positions"
        className="py-20 bg-white/20 dark:bg-gray-950/20"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-display font-bold text-gray-900 dark:text-white mb-4">
      ...
      <section className="py-20 bg-gradient-to-r from-primary-600/70 via-primary-700/70 to-secondary-600/70 backdrop-blur-sm">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-primary-100 mb-10 leading-relaxed">
            ...
            make a difference. Send us your resume and let&apos;s explore how
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="mailto:careers@carefinder.lk"
