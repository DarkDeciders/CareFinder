        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-6">
              ...
              <Link href="/careers" className="text-gray-700 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 font-medium transition-colors">
                Careers
              </Link>
              ...
              <div className="bg-white/70 dark:bg-gray-800/70 rounded-2xl p-8 shadow-soft dark:shadow-lg border border-gray-100/50 dark:border-gray-700/50">
                <div className="space-y-4">
                  {officeHours.map((schedule, index) => (
                    <div key={index} className="flex justify-between items-center py-3 border-b border-gray-200/50 dark:border-gray-700/50 last:border-b-0">
                ...
                <div className="mt-8 p-4 bg-primary-50 dark:bg-primary-900/20 rounded-lg">
                  <h4 className="font-semibold text-primary-800 dark:text-primary-200 mb-2">Emergency Support</h4>
                  <p className="text-primary-700 dark:text-primary-300 text-sm">
                    For urgent care-related issues, our emergency support line is available 24/7 at +94 77 999 8888
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-12 lg:mt-0">
              ...
              <div className="bg-white/70 dark:bg-gray-800/70 rounded-2xl p-8 shadow-soft dark:shadow-lg border border-gray-100/50 dark:border-gray-700/50">
                <div className="flex items-start space-x-4 mb-6">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 dark:text-white mb-2">CareFinder Headquarters</h4>
                    <p className="text-gray-600 dark:text-gray-300">
                      123 Galle Road<br />
                ...
                <div className="mt-6 pt-6 border-t border-gray-200/50 dark:border-gray-700/50">
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-4">Getting Here</h4>
            ...
            {[
              {
                ...
                answer: "We aim to respond to all inquiries within 24 hours during business days. For urgent care-related issues, please call our emergency support line."
              },
              {
                question: "Do you offer customer support in local languages?",
                answer: "Yes! Our customer support team is fluent in English, Sinhala, and Tamil to better serve all our users across Sri Lanka."
              },
              {
                question: "Can I schedule a meeting with your team?",
                answer: "Absolutely! For partnership discussions, media inquiries, or detailed consultations, we're happy to schedule a meeting. Please mention your preferred time in your message."
              },
              {
                question: "How can I report a technical issue?",
                answer: "Technical issues can be reported through our contact form by selecting 'Customer Support' as the category, or by emailing us directly at support@carefinder.lk."
              }
            ].map((faq, index) => (
              <div key={index} className="bg-white/70 dark:bg-gray-800/70 rounded-2xl p-6 shadow-soft dark:shadow-lg border border-gray-100/50 dark:border-gray-700/50">
      ...
      <section className="py-20 bg-gradient-to-r from-primary-600/70 via-primary-700/70 to-secondary-600/70 backdrop-blur-sm">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-primary-100 mb-10 leading-relaxed">
            Join thousands of families who trust CareFinder for their care needs. 
            Create your account today and find the perfect caregiver for your family.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/about" className="border-2 border-white text-white px-8 py-4 rounded-xl text-lg font-semibold hover:bg-white/10 transition-all duration-300 text-center">
              Learn More
            </Link>
          </div>
        </div>
