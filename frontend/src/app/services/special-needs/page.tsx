  ...
  const careServices = [
    {
      ...
      description: "Positive behavior interventions, de-escalation techniques, and emotional regulation support."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Age-appropriate activities and support for individuals with intellectual and developmental disabilities."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Support with prescribed exercises, mobility assistance, and coordination with physical therapists."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Assistance with verbal and non-verbal communication, including support for alternative communication methods."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Assistance with daily living activities including bathing, dressing, and personal hygiene with dignity."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Structured activities to improve social interaction, relationship building, and community integration."
    }
  ];
  ...
  const conditions = [
    {
      ...
      description: "Specialized care for individuals with autism, focusing on communication, social skills, and sensory needs.",
      features: [
    ...
    },
    {
      ...
      description: "Comprehensive support for individuals with intellectual disabilities to promote independence and quality of life.",
      features: [
    ...
    },
    {
      ...
      description: "Adaptive care services for individuals with physical disabilities, mobility challenges, or chronic conditions.",
      features: [
    ...
    },
    {
      ...
      description: "Supportive care for individuals managing mental health conditions alongside developmental or physical disabilities.",
      features: [
      ...
      <div className="bg-gray-50 dark:bg-gray-900/50 py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center space-x-2 text-sm">
            ...
            <span className="text-primary-600 dark:text-primary-400 font-medium">Special Needs</span>
          </div>
        </div>
      </div>
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
            <div>
              ...
              <p className="mt-6 text-xl text-gray-600 dark:text-gray-300 leading-relaxed mb-8">
                Expert care services for individuals with special needs, developmental disabilities, and unique support requirements. 
                Our trained professionals provide personalized, dignified care that promotes independence and wellbeing.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/register" className="group bg-gradient-to-r from-purple-600 to-violet-600 hover:from-purple-700 hover:to-violet-700 text-white px-8 py-4 rounded-xl text-lg font-semibold transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 text-center">
                  Find Special Needs Specialists
                  <svg className="inline-block ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
                  </svg>
                </Link>
                <Link href="/contact" className="border-2 border-purple-600 text-purple-600 hover:bg-purple-600 hover:text-white px-8 py-4 rounded-xl text-lg font-semibold transition-all duration-300 text-center">
                  Learn More
                </Link>
              </div>
            </div>
            ...
            <div className="mt-12 lg:mt-0">
              <div className="bg-white/70 dark:bg-gray-800/70 rounded-3xl p-8 shadow-soft dark:shadow-lg border border-gray-100/50 dark:border-gray-700/50">
                ...
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                  Our caregivers receive specialized training in disability support, behavioral interventions, and adaptive care techniques. 
                  Every specialist is certified and experienced in working with diverse special needs conditions.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Individualized care plans tailored to unique abilities, challenges, and goals for each person we serve
            </p>
          </div>
      ...
      <section className="py-20 bg-white/10 dark:bg-gray-950/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Specialized care approaches for a wide range of developmental, intellectual, physical, and mental health conditions
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {conditions.map((condition, index) => (
              <div key={index} className="bg-white/70 dark:bg-gray-800/70 rounded-3xl p-8 shadow-soft dark:shadow-lg border border-gray-100/50 dark:border-gray-700/50">
                <div className={`w-16 h-16 bg-gradient-to-br ${condition.color} rounded-2xl mb-6 flex items-center justify-center text-white shadow-lg`}>
                  <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                  </svg>
                </div>
      ...
      <section className="py-20 bg-white/20 dark:bg-gray-950/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Tailored support that evolves with developmental stages and changing needs throughout the lifespan
            </p>
          </div>
              ...
              <div key={index} className="bg-white/70 dark:bg-gray-800/70 rounded-3xl p-8 shadow-soft dark:shadow-lg border border-gray-100/50 dark:border-gray-700/50">
                <div className="lg:grid lg:grid-cols-3 lg:gap-8 items-start">
                  ...
                  <div className="lg:col-span-2 mt-8 lg:mt-0">
                    <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-6">Support Focus Areas:</h4>
      ...
      <section className="py-20 bg-white/10 dark:bg-gray-950/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Expert care that celebrates abilities, supports challenges, and promotes independence with dignity
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "All caregivers receive specialized disability support training, behavior intervention certification, and ongoing professional development."
              },
              {
                icon: (
                  <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                description: "Individual assessment and customized support plans that address specific needs, preferences, and goals."
              },
              {
                icon: (
                  <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                description: "Close partnership with families, caregivers, and healthcare teams to ensure consistent, coordinated support."
              },
              {
                icon: (
                  <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                description: "Flexible, creative support methods that adapt to changing needs, preferences, and circumstances."
              },
              {
                icon: (
                  <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                description: "Available for short-term respite care, regular ongoing support, or intensive daily assistance as needed."
              },
              {
                icon: (
                  <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                description: "Support for community participation, social activities, and building meaningful relationships and connections."
              }
            ].map((item, index) => (
      ...
      <section className="py-20 bg-gradient-to-r from-purple-600/70 via-purple-700/70 to-violet-600/70 backdrop-blur-sm">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-purple-100 mb-10 leading-relaxed">
            Connect with certified special needs specialists who understand unique care requirements. 
            Compassionate, professional support that celebrates abilities and promotes independence.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/register" className="group bg-white text-purple-600 px-8 py-4 rounded-xl text-lg font-semibold hover:bg-gray-50 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 text-center">
              Find Special Needs Specialists
              <svg className="inline-block ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
              </svg>
