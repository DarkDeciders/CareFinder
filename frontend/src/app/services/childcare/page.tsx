  ...
  const services = [
    {
      ...
      description:
        "Safe supervision and educational activities for school-age children from 3:00 PM to 7:00 PM.",
    },
    {
      icon: (
        <svg
        ...
        >
          <path
            ...
            strokeLinejoin="round"
            strokeWidth={2}
            d="M14.828 14.828a4 4 0 01-5.656 0M9 10h1a3 3 0 000-6h-1m4 6V4a3 3 0 013 3v2.5"
          />
        </svg>
      ),
      title: "Weekend Babysitting",
      description:
        "Flexible weekend care allowing parents time for personal activities or date nights.",
    },
    {
      icon: (
        <svg
        ...
        >
          <path
            ...
            strokeLinejoin="round"
            strokeWidth={2}
            d="M8 7V3a4 4 0 118 0v4m-8 0h8m-8 0H4a2 2 0 00-2 2v10a2 2 0 002 2h16a2 2 0 002-2V9a2 2 0 00-2-2h-4m-8 0V9"
          />
        </svg>
      ),
      title: "Holiday Care",
      description:
        "Full-day care during school holidays with engaging activities and educational programs.",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Homework assistance, reading support, and creative learning activities to enhance development.",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Nutritious meal planning and preparation following dietary requirements and preferences.",
    },
    {
      icon: (
        <svg
        ...
        >
          <path
            ...
            strokeLinejoin="round"
            strokeWidth={2}
            d="M8 7a4 4 0 108 0m0 0v10a2 2 0 01-2 2H10a2 2 0 01-2-2V7m8 0V5a2 2 0 00-2-2H10a2 2 0 00-2 2v2m8 0h2a2 2 0 012 2v2M4 9h2a2 2 0 012 2v2"
          />
        </svg>
      ),
      title: "Transportation",
      description:
        "Safe transportation to and from school, activities, and appointments with verified drivers.",
    },
  ];
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
            <div>
              ...
              <p className="mt-6 text-xl text-gray-600 dark:text-gray-300 leading-relaxed mb-8">
                Safe, nurturing, and educational childcare solutions for busy
                families. Our experienced caregivers provide personalized
                attention to help your children thrive.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  href="/register"
                  className="group bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white px-8 py-4 rounded-xl text-lg font-semibold transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 text-center"
                >
                ...
                <Link
                  href="/contact"
                  className="border-2 border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white px-8 py-4 rounded-xl text-lg font-semibold transition-all duration-300 text-center"
                >
                  Learn More
                </Link>
              </div>
            ...
            <div className="mt-12 lg:mt-0">
              <div className="bg-white/70 dark:bg-gray-800/70 rounded-3xl p-8 shadow-soft dark:shadow-lg border border-gray-100/50 dark:border-gray-700/50">
                ...
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                  Join hundreds of Sri Lankan families who trust CareFinder for
                  their childcare needs. Our background-checked caregivers
                  provide peace of mind and exceptional care.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              From after-school supervision to weekend care, we provide flexible
      ...
      <section className="py-20 bg-white/10 dark:bg-gray-950/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Tailored care approaches designed for each developmental stage of
              childhood
            </p>
          </div>
            ...
            {ageGroups.map((group, index) => (
              ...
              >
                <div className="lg:grid lg:grid-cols-3 lg:gap-8 items-center">
                  <div>
                    <div
                      className={`w-16 h-16 bg-gradient-to-br ${group.color} rounded-2xl mb-6 flex items-center justify-center text-white shadow-lg`}
                    >
                      <svg
                        className="w-8 h-8"
                        fill="none"
            ...
            {[
              {
                ...
                description:
                  "All childcare providers undergo comprehensive background checks, reference verification, and child safety training.",
              },
              {
                icon: (
                  <svg
                ...
                description:
                  "Book care for a few hours, full days, or regular weekly schedules that fit your family's routine.",
              },
              {
                icon: (
                  <svg
                ...
                description:
                  "Our caregivers incorporate learning activities, homework help, and developmental play into every session.",
              },
              {
                icon: (
                  <svg
                ...
                description:
                  "Receive photos, updates, and detailed reports about your child's activities and progress throughout the day.",
              },
              {
                icon: (
                  <svg
                ...
                description:
                  "All caregivers are first aid certified and trained in emergency procedures for child safety.",
              },
              {
                icon: (
                  <svg
                ...
                description:
                  "We work closely with parents to maintain routines, values, and parenting approaches that matter to your family.",
              },
            ].map((item, index) => (
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600/70 via-blue-700/70 to-indigo-600/70 backdrop-blur-sm">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-10 leading-relaxed">
            Join hundreds of Sri Lankan families who&apos;ve found peace of mind
            with our verified childcare providers. Quality care for your
            children is just a few clicks away.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/register"
              className="group bg-white text-blue-600 px-8 py-4 rounded-xl text-lg font-semibold hover:bg-gray-50 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 text-center"
            >
              Find Childcare Providers
              <svg
                className="inline-block ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform"
