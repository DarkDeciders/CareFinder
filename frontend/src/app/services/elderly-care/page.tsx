  ...
  const careServices = [
    {
      ...
      description:
        "Daily living support including bathing, dressing, grooming, and mobility assistance with dignity and respect.",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Safe medication administration, prescription tracking, and coordination with healthcare providers.",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Meaningful conversation, social activities, and emotional support to combat loneliness and isolation.",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Nutritious meal planning, cooking, and dietary management tailored to specific health needs and preferences.",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Maintaining a clean, safe living environment with laundry, tidying, and organization services.",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Transportation to appointments, medical advocacy, and communication with healthcare teams.",
    },
  ];
  ...
  const careTypes = [
    {
      ...
      description:
        "For seniors who live independently but need occasional assistance with daily tasks.",
      features: [
    ...
    },
    {
      ...
      description:
        "Comprehensive assistance for seniors who need help with personal care activities.",
      features: [
    ...
    },
    {
      ...
      description:
        "Specialized care for individuals with Alzheimer&apos;s, dementia, or cognitive impairments.",
      features: [
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
            <div>
              ...
              <p className="mt-6 text-xl text-gray-600 dark:text-gray-300 leading-relaxed mb-8">
                Dignified, professional elderly care services that allow your
                loved ones to age comfortably in their own homes. Our trained
                caregivers provide personalized support with compassion and
                respect.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  href="/register"
                  className="group bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white px-8 py-4 rounded-xl text-lg font-semibold transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 text-center"
                >
                ...
                <Link
                  href="/contact"
                  className="border-2 border-green-600 text-green-600 hover:bg-green-600 hover:text-white px-8 py-4 rounded-xl text-lg font-semibold transition-all duration-300 text-center"
                >
                  Learn More
                </Link>
              </div>
            ...
            <div className="mt-12 lg:mt-0">
              <div className="bg-white/70 dark:bg-gray-800/70 rounded-3xl p-8 shadow-soft dark:shadow-lg border border-gray-100/50 dark:border-gray-700/50">
                ...
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                  Our specialized elderly care providers are trained in
                  geriatric care, dementia support, and senior safety. All
                  caregivers undergo extensive background checks and ongoing
                  training.
                </p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Professional care services designed to support seniors in
              maintaining independence, dignity, and quality of life at home
            </p>
          </div>
      ...
      <section className="py-20 bg-white/10 dark:bg-gray-950/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Flexible care plans designed to meet varying levels of
              ...
              >
                <div className="lg:grid lg:grid-cols-3 lg:gap-8 items-start">
                  <div className="lg:col-span-1">
                    <div
                      className={`w-16 h-16 bg-gradient-to-br ${type.color} rounded-2xl mb-6 flex items-center justify-center text-white shadow-lg`}
                    >
                      <svg
                        className="w-8 h-8"
                        fill="none"
      ...
      <section className="py-20 bg-white/20 dark:bg-gray-950/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Real stories from Sri Lankan families who trust us with their
              loved ones
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <div
                key={index}
                className="bg-white/70 dark:bg-gray-800/70 rounded-2xl p-8 shadow-soft dark:shadow-lg border border-gray-100/50 dark:border-gray-700/50"
              >
      ...
      <section className="py-20 bg-white/10 dark:bg-gray-950/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Comprehensive support that prioritizes dignity, comfort, and
            ...
            {[
              {
                ...
                description:
                  "Caregivers trained specifically in elderly care, dementia support, and age-related health conditions.",
              },
              {
                icon: (
                  <svg
                ...
                description:
                  "Round-the-clock care options available for families needing extended or overnight support.",
              },
              {
                icon: (
                  <svg
                ...
                description:
                  "Regular updates, care reports, and open communication channels with family members.",
              },
              {
                icon: (
                  <svg
                ...
                description:
                  "Support with healthcare appointments, medication management, and therapy coordination.",
              },
            ].map((item, index) => (
      ...
      <section className="py-20 bg-gradient-to-r from-green-600/70 via-green-700/70 to-emerald-600/70 backdrop-blur-sm">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-green-100 mb-10 leading-relaxed">
            Connect with experienced elderly care specialists who understand the
            unique needs of Sri Lankan seniors. Compassionate, professional care
            that allows aging in place with dignity and comfort.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/register"
              className="group bg-white text-green-600 px-8 py-4 rounded-xl text-lg font-semibold hover:bg-gray-50 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 text-center"
            >
