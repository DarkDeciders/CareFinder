  ...
  const services = [
    {
      ...
      description:
        "Professional childcare solutions for busy families, ensuring your children receive safe, nurturing, and educational care.",
      icon: (
        <svg
          className="w-12 h-12"
          fill="none"
    ...
    },
    {
      title: "Elderly Care",
      description:
        "Compassionate elderly care services providing dignity, comfort, and professional medical support for seniors in their own homes.",
      icon: (
        <svg
          className="w-12 h-12"
          fill="none"
    ...
    },
    {
      ...
      description:
        "Specialized care services for individuals with special needs, delivered by trained professionals with expertise in disability support.",
      icon: (
        <svg
          className="w-12 h-12"
          fill="none"
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            ...
            <p className="mt-6 text-xl text-gray-600 dark:text-gray-300 mx-auto max-w-3xl leading-relaxed">
              ...
              every family member. From childcare to elderly care and
              specialized support, we&apos;re here to help.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-16">
            {services.map((service, index) => (
              <div
                key={index}
                className={`lg:grid lg:grid-cols-2 lg:gap-16 items-center ${index % 2 === 1 ? "lg:grid-cols-2" : ""}`}
              >
                <div className={index % 2 === 1 ? "lg:order-2" : ""}>
                  <div
                    className={`w-20 h-20 bg-gradient-to-br ${service.color} rounded-2xl mb-6 flex items-center justify-center text-white shadow-lg`}
                  >
                    {service.icon}
                  </div>
                ...
                <div
                  className={`mt-12 lg:mt-0 ${index % 2 === 1 ? "lg:order-1" : ""}`}
                >
                  <div className="bg-white/70 dark:bg-gray-800/70 rounded-3xl p-8 shadow-soft dark:shadow-lg border border-gray-100/50 dark:border-gray-700/50">
                    <div className="aspect-w-16 aspect-h-12 bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-800 rounded-2xl flex items-center justify-center">
                      <div
                        className={`w-24 h-24 bg-gradient-to-br ${service.color} rounded-full flex items-center justify-center text-white shadow-2xl`}
                      >
                        {service.icon}
                      </div>
                    </div>
                    <div className="mt-8">
                      ...
                      <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                        Our certified professionals undergo rigorous background
                        checks and continuous training to ensure the highest
                        quality of care for your loved ones.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Our comprehensive approach to quality assurance across all service
              categories
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Comprehensive background checks, reference verification, and skills assessment for all caregivers.",
              },
              {
                icon: (
                  <svg
                ...
                description:
                  "Regular professional development sessions and specialized training programs for different care needs.",
              },
              {
                icon: (
                  <svg
                ...
                description:
                  "Regular check-ins, family feedback collection, and continuous improvement of care standards.",
              },
              {
                icon: (
                  <svg
                ...
                title: "24/7 Support",
                description:
                  "Round-the-clock support system for families and caregivers with emergency response protocols.",
              },
            ].map((item, index) => (
      ...
      <section className="py-20 bg-gradient-to-r from-primary-600/70 via-primary-700/70 to-secondary-600/70 backdrop-blur-sm">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-primary-100 mb-10 leading-relaxed">
            ...
            family&apos;s unique needs. Quality care is just a click away.
          </p>
