      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
          ...
          <p className="mt-6 text-xl text-gray-600 dark:text-gray-300 leading-relaxed mb-8">
            Your privacy is important to us. This policy explains how CareFinder
            collects, uses, and protects your personal information when using
            our care services platform.
          </p>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                  CareFinder (&quot;we,&quot; &quot;our,&quot; or
                  &quot;us&quot;) operates a care services platform that
                  connects families with verified caregivers across Sri Lanka.
                  We are committed to protecting your privacy and being
                  transparent about how we collect, use, and share your personal
                  information. This Privacy Policy applies to all users of our
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                  ...
                  will notify users of material changes via email or through our
                  platform. Continued use of our services after updates
