          ...
          <div className="md:hidden bg-white/95 dark:bg-gray-950/95 backdrop-blur-lg border-b border-gray-200 dark:border-gray-800">
            <div className="px-4 py-3 space-y-3">
              ...
              <div className="flex space-x-3 mt-3">
                <a
                  href="/register"
                  className="flex-1 text-center border border-primary-600 text-primary-600 px-6 py-2 rounded-lg font-medium transition-colors"
                >
                  {t("nav.register")}
                </a>
                <a
                  href="/login"
                  className="flex-1 text-center bg-primary-600 hover:bg-primary-700 text-white px-6 py-2 rounded-lg font-medium transition-colors shadow-sm"
                >
                  {t("nav.login")}
                </a>
              </div>
          ...
          <div className="text-center animate-fade-in">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a
                  href="/about"
                  className="group border-2 border-secondary-600 dark:border-secondary-400 text-secondary-600 dark:text-secondary-400 hover:bg-secondary-50 dark:hover:bg-secondary-900/20 px-8 py-4 rounded-xl text-lg font-semibold transition-all duration-300 text-center"
                >
                  {t("nav.about")}
                  <svg
                    className="inline-block ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform"
              ...
              <div className="w-16 h-16 bg-gradient-to-br from-primary-500 to-primary-600 rounded-2xl mb-6 flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
                ...
                >
                  <path
                    ...
                    strokeLinejoin="round"
                    strokeWidth={2}
                    d="M14.828 14.828a4 4 0 01-5.656 0M9 10h1a3 3 0 000-6h-1m4 6V4a3 3 0 013 3v2.5M15 11V9a3 3 0 00-3-3h-2m8 8v2a2 2 0 01-2 2H5a2 2 0 01-2-2v-2m0 0V9a2 2 0 012-2h14a2 2 0 012 2v2"
                  />
                </svg>
              </div>
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">
                {t("services.childcare.title")}
              </h3>
            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start group">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 dark:text-white mb-2 text-lg">
                      {t("safety.payment.title")}
                    </h3>
                    <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                      {t("safety.payment.desc")}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start group">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 dark:text-white mb-2 text-lg">
                      {t("safety.quality.title")}
                    </h3>
                    <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                      {t("safety.quality.desc")}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-primary-600/80 to-secondary-600/80 rounded-3xl p-8 text-white shadow-2xl backdrop-blur-sm">
                ...
                <div className="grid grid-cols-2 gap-8">
                  <div className="text-center">
                    <div className="text-4xl font-bold mb-2 animate-pulse-soft">
                      1000+
                    </div>
