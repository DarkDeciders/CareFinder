      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
          ...
          <p className="mt-6 text-xl text-gray-600 dark:text-gray-300 leading-relaxed mb-8">
            Please read these terms carefully before using CareFinder&apos;s
            care services platform. By using our services, you agree to be bound
          ...
          <div className="inline-flex items-center space-x-2 bg-white/70 dark:bg-gray-800/70 rounded-full px-6 py-3 shadow-soft">
            ...
            <span className="text-sm font-medium text-gray-700 dark:text-gray-300">
              {`Effective: September ${getCurrentYear()}`}
            </span>
          </div>
        </div>
      </section>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                  ...
                  legally binding agreement between you and CareFinder (Pvt)
                  Ltd, a company registered in Sri Lanka. These Terms govern
                  your access to and use of our care services platform,
                  including our website, mobile applications, and related
                  services. Please read these Terms carefully and contact us if
                  you have any questions before using our platform.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                  ...
                  platform notifications. Continued use of our services after
                  updates constitutes acceptance of the revised Terms. If you do
                  not agree to updated Terms, you must discontinue use of our
                  platform.
                </p>
              </div>
            </div>
