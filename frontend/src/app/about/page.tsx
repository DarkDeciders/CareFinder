  ...
  const values = [
    {
      ...
      title: "Trust & Safety",
      description:
        "We prioritize the safety of families and caregivers through comprehensive background checks and verification processes.",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Every caregiver on our platform is driven by genuine care and dedication to improving lives.",
    },
    {
      icon: (
        <svg
      ...
      title: "Innovation",
      description:
        "We leverage cutting-edge AI technology to enhance safety, streamline connections, and improve experiences.",
    },
    {
      icon: (
        <svg
      ...
      title: "Community",
      description:
        "Building a supportive community where families and caregivers can connect, grow, and thrive together.",
    },
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            ...
            <p className="mt-6 text-xl text-gray-600 dark:text-gray-300 mx-auto max-w-3xl leading-relaxed">
              We&apos;re on a mission to revolutionize care services in Sri
              Lanka by connecting families with verified, compassionate
              caregivers through cutting-edge technology and unwavering
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
            <div>
              ...
              <div className="space-y-6 text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                <p>
                  CareFinder was born from a simple yet powerful observation:
                  finding trustworthy, qualified caregivers shouldn&apos;t be a
                  stressful, uncertain process for families who need care the
                  most.
                </p>
                <p>
                  As a team of passionate technologists and care advocates, we
                  recognized the gap between families seeking reliable care
                  services and qualified caregivers looking for meaningful work
                  opportunities in Sri Lanka.
                </p>
                <p>
                  Today, we&apos;re proud to bridge this gap with a platform
                  that prioritizes safety, transparency, and genuine
                  connections, making quality care accessible to families across
                  the island while providing caregivers with opportunities to
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="bg-white/70 dark:bg-gray-800/70 rounded-2xl p-8 shadow-soft hover:shadow-soft-lg dark:shadow-lg dark:hover:shadow-2xl transition-all duration-300 border border-gray-100/50 dark:border-gray-700/50">
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed text-lg">
                To revolutionize care services in Sri Lanka by creating a
                trusted, AI-powered platform that seamlessly connects families
                with verified caregivers, ensuring safe, reliable, and
                compassionate care for every family member.
              </p>
            </div>
            ...
            <div className="bg-white/70 dark:bg-gray-800/70 rounded-2xl p-8 shadow-soft hover:shadow-soft-lg dark:shadow-lg dark:hover:shadow-2xl transition-all duration-300 border border-gray-100/50 dark:border-gray-700/50">
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed text-lg">
                To become the leading care service platform in South Asia, where
                every family has access to quality, affordable care services,
                and every caregiver has the opportunity to build a fulfilling
                career while making a meaningful impact in their community.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="w-full">
            {(() => {
              ...
              return (
                <>
                  {/* Render the Team Leader, centered and prominent */}
                  {teamLeader && (
                    <div className="flex justify-center mb-10">
                      <div className="group bg-white/70 dark:bg-gray-800/70 rounded-2xl p-8 shadow-soft hover:shadow-soft-lg dark:shadow-lg dark:hover:shadow-2xl transition-all duration-300 border border-gray-100/50 dark:border-gray-700/50 text-center w-full max-w-xs">
                  ...
                  {/* Render the rest of the team members in a symmetrical, centered grid */}
                  <div className="flex flex-wrap justify-center gap-8">
                    {otherMembers.map((member, index) => (
                      <div
                        key={index}
                        className="group bg-white/70 dark:bg-gray-800/70 rounded-2xl p-8 shadow-soft hover:shadow-soft-lg dark:shadow-lg dark:hover:shadow-2xl transition-all duration-300 border border-gray-100/50 dark:border-gray-700/50 text-center w-full max-w-xs sm:w-auto"
                      >
                        <div className="w-24 h-24 bg-gradient-to-br from-primary-500 to-secondary-500 rounded-full mx-auto mb-6 flex items-center justify-center text-white text-2xl font-bold shadow-lg group-hover:scale-110 transition-transform">
                          {member.name
                            .split(" ")
      ...
      <section className="py-20 bg-gradient-to-r from-primary-600/70 via-primary-700/70 to-secondary-600/70 backdrop-blur-sm">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-primary-100 mb-10 leading-relaxed">
            Join our growing community of families and caregivers. Experience
            the peace of mind that comes with trusted, verified care services.
          </p>
