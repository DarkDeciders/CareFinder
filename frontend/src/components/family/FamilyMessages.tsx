...
export default function FamilyMessages() {
  ...
  const conversations: Conversation[] = [
    {
      ...
      name: 'Sarah Chen',
      role: 'Caregiver',
      lastMessage: 'Thank you for the feedback! I\'m looking forward to our next session.',
    ...
    },
    {
      ...
      name: 'Mike Johnson',
      role: 'Caregiver',
      lastMessage: 'I can be there by 2 PM tomorrow. Should I bring any specific supplies?',
    ...
    },
    {
      ...
      role: 'Support Team',
      lastMessage: 'Your booking has been confirmed. Agent verification is scheduled.',
    ...
    },
    {
      ...
      name: 'Emma Williams',
      role: 'Caregiver',
      lastMessage: 'Hi! I saw your request for weekend childcare. I\'m available!',
    ...
    const allMessages = [
      {
        ...
        content: 'Hello! I wanted to update you on today\'s session with little Emma.',
      ...
      },
      {
        ...
        senderId: 1,
        senderName: 'Sarah Chen',
        content: 'It went wonderfully! Emma was very engaged during our reading time and enjoyed the art activities. She ate her lunch well and took a good nap.',
      ...
      },
      {
        ...
        senderId: 1,
        senderName: 'Sarah Chen',
        content: 'I also helped her with some basic counting exercises. She\'s getting really good at recognizing numbers 1-10!',
      ...
      },
      {
        ...
        senderId: 'family',
        senderName: 'You',
        content: 'That\'s wonderful to hear! Thank you for the detailed update. Emma has been talking about the stories you read together.',
      ...
      },
      {
        ...
        senderId: 1,
        senderName: 'Sarah Chen',
        content: 'Thank you for the feedback! I\'m looking forward to our next session.',
        timestamp: '2024-12-20T16:30:00',
        type: 'text'
      },
      {
        ...
        content: 'I can be there by 2 PM tomorrow. Should I bring any specific supplies?',
        timestamp: '2024-12-20T14:22:00',
        type: 'text'
      },
      {
        ...
        senderId: 'family',
        senderName: 'You',
        content: 'Perfect! Just bring your usual supplies. Thank you for confirming.',
  ...
  const generateReply = (userMessage: string, caregiverName: string): string => {
    ...
    if (caregiverName === 'Mike Johnson') {
      ...
      if (lowerMessage.includes('elderly') || lowerMessage.includes('grandmother')) {
    ...
    if (caregiverName === 'Emma Williams') {
      ...
      if (lowerMessage.includes('weekend') || lowerMessage.includes('childcare')) {
  ...
  return (
    <div className="h-[calc(100vh-12rem)] lg:h-[calc(100vh-12rem)] flex flex-col lg:flex-row bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-2xl border border-gray-200/50 dark:border-gray-700/50 overflow-hidden">
      {/* Conversations List */}
      <div className={`${showConversations ? 'flex' : 'hidden'} lg:flex w-full lg:w-1/3 border-b lg:border-b-0 lg:border-r border-gray-200 dark:border-gray-600 flex-col h-full max-h-full`}>
          ...
          {conversations.map((conversation) => (
            <div
              ...
              className={`p-3 sm:p-4 border-b border-gray-100 dark:border-gray-700 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors ${
                selectedConversation === conversation.id ? 'bg-primary-50 dark:bg-primary-900/20 lg:border-r-2 lg:border-r-primary-500' : ''
              }`}
            >
              <div className="flex items-center space-x-3">
                <div className="relative">
                  ...
                  <div className={`absolute bottom-0 right-0 w-3 h-3 ${getStatusColor(conversation.status)} rounded-full border-2 border-white dark:border-gray-800`}></div>
                </div>
      ...
      {/* Chat Area */}
      <div className={`${!showConversations ? 'flex' : 'hidden'} lg:flex flex-1 flex-col h-full max-h-full`}>
        {selectedConv ? (
          <>
            {/* Chat Header */}
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div className="relative">
                    ...
                    <div className={`absolute bottom-0 right-0 w-3 h-3 ${getStatusColor(selectedConv.status)} rounded-full border-2 border-white dark:border-gray-800`}></div>
                  </div>
                  <div>
                    <h3 className="text-sm sm:text-base font-medium text-gray-900 dark:text-white">{selectedConv.name}</h3>
            ...
            <div className="flex-1 overflow-y-auto p-3 sm:p-4 space-y-3 sm:space-y-4 min-h-0">
              {conversationMessages.map((message) => (
                ...
                >
                  <div className={`max-w-xs lg:max-w-md px-3 sm:px-4 py-2 rounded-2xl ${
