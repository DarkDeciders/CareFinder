    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center space-y-3 sm:space-y-0">
        ...
        <div className="flex items-center space-x-2 bg-success-100 dark:bg-success-900/20 px-3 py-1 rounded-full">
          ...
          <span className="text-xs text-success-700 dark:text-success-400 font-medium">System Operational</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-gray-200/50 dark:border-gray-700/50">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">2,847</p>
        ...
        <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-gray-200/50 dark:border-gray-700/50">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 font-medium">Active Bookings</p>
              <p className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">1,342</p>
              <p className="text-xs text-success-600 dark:text-success-400">+8% this week</p>
            </div>
        ...
        <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-gray-200/50 dark:border-gray-700/50">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 font-medium">Revenue (Monthly)</p>
              <p className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">$84,950</p>
              <p className="text-xs text-success-600 dark:text-success-400">+15% vs last month</p>
            </div>
        ...
        <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-gray-200/50 dark:border-gray-700/50">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 font-medium">Satisfaction Rate</p>
              <p className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">94.8%</p>
              <p className="text-xs text-success-600 dark:text-success-400">+2.1% improvement</p>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                <p className="text-sm font-semibold text-gray-900 dark:text-white">1,245</p>
                <p className="text-xs text-gray-500 dark:text-gray-400">43.7%</p>
              </div>
            </div>
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                <div className="w-3 h-3 bg-secondary-500 rounded-full"></div>
                <span className="text-sm text-gray-700 dark:text-gray-300">Caregivers</span>
              </div>
              <div className="text-right">
                <p className="text-sm font-semibold text-gray-900 dark:text-white">987</p>
                <p className="text-xs text-gray-500 dark:text-gray-400">34.7%</p>
              </div>
            </div>
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
              ...
              <div className="text-right">
                <p className="text-sm font-semibold text-gray-900 dark:text-white">78</p>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-sm text-gray-700 dark:text-gray-300">Trainers</span>
              </div>
              <div className="text-right">
                <p className="text-sm font-semibold text-gray-900 dark:text-white">45</p>
        ...
        {/* Recent Activity */}
        <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-gray-200/50 dark:border-gray-700/50">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Recent Platform Activity</h2>
          <div className="space-y-3">
            <div className="flex items-start space-x-3 p-3 bg-primary-50/50 dark:bg-primary-900/10 rounded-lg">
              <div className="w-2 h-2 bg-primary-500 rounded-full mt-2"></div>
              <div className="flex-1 min-w-0">
                <p className="text-sm text-gray-900 dark:text-white font-medium">New caregiver registration</p>
                <p className="text-xs text-gray-600 dark:text-gray-400">Sarah Johnson completed verification</p>
            ...
            <div className="flex items-start space-x-3 p-3 bg-secondary-50/50 dark:bg-secondary-900/10 rounded-lg">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm text-gray-900 dark:text-white font-medium">Booking confirmed</p>
                <p className="text-xs text-gray-600 dark:text-gray-400">Family Martinez scheduled childcare</p>
            ...
            <div className="flex items-start space-x-3 p-3 bg-success-50/50 dark:bg-success-900/10 rounded-lg">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm text-gray-900 dark:text-white font-medium">Agent verification completed</p>
                <p className="text-xs text-gray-600 dark:text-gray-400">Quality check passed for Thompson family</p>
            ...
            <div className="flex items-start space-x-3 p-3 bg-warning-50/50 dark:bg-warning-900/10 rounded-lg">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm text-gray-900 dark:text-white font-medium">Training session scheduled</p>
                <p className="text-xs text-gray-600 dark:text-gray-400">Elderly care training for 3 caregivers</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        {/* Pending Actions */}
        <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-gray-200/50 dark:border-gray-700/50">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Pending Actions</h2>
          <div className="space-y-3">
            <div className="flex items-center justify-between p-2 bg-warning-50/50 dark:bg-warning-900/10 rounded-lg">
              <div className="flex items-center space-x-2">
                <div className="w-2 h-2 bg-warning-500 rounded-full"></div>
                <span className="text-sm text-gray-700 dark:text-gray-300">Verifications</span>
              </div>
              <span className="text-sm font-semibold text-warning-700 dark:text-warning-400">12</span>
            </div>
            <div className="flex items-center justify-between p-2 bg-primary-50/50 dark:bg-primary-900/10 rounded-lg">
              ...
              <span className="text-sm font-semibold text-primary-700 dark:text-primary-400">8</span>
            </div>
            <div className="flex items-center justify-between p-2 bg-red-50/50 dark:bg-red-900/10 rounded-lg">
              <div className="flex items-center space-x-2">
                <div className="w-2 h-2 bg-red-500 rounded-full"></div>
                <span className="text-sm text-gray-700 dark:text-gray-300">Support Tickets</span>
              </div>
              <span className="text-sm font-semibold text-red-700 dark:text-red-400">4</span>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-gray-200/50 dark:border-gray-700/50">
        <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">CareFinder Platform Overview</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <h3 className="text-base font-medium text-gray-900 dark:text-white mb-3">Platform Capabilities</h3>
            <div className="space-y-3 text-sm text-gray-700 dark:text-gray-300">
              <div className="flex items-start space-x-2">
                <div className="w-2 h-2 bg-primary-500 rounded-full mt-1.5"></div>
                <div>
                  <span className="font-medium">Family Management:</span> Families can search, book, and manage caregiver services with real-time communication and scheduling
                </div>
              </div>
              <div className="flex items-start space-x-2">
                <div className="w-2 h-2 bg-secondary-500 rounded-full mt-1.5"></div>
                <div>
                  <span className="font-medium">Caregiver Platform:</span> Caregivers manage their profiles, availability, job applications, and client communications
                </div>
              </div>
              <div className="flex items-start space-x-2">
                <div className="w-2 h-2 bg-success-500 rounded-full mt-1.5"></div>
                <div>
                  <span className="font-medium">Quality Assurance:</span> Field agents conduct on-site verifications and quality checks to ensure service standards
                </div>
              </div>
              <div className="flex items-start space-x-2">
                <div className="w-2 h-2 bg-warning-500 rounded-full mt-1.5"></div>
                <div>
                  <span className="font-medium">Training System:</span> Certified trainers provide skill development and assessment programs for caregivers
                </div>
              </div>
            </div>
          </div>
          <div>
            <h3 className="text-base font-medium text-gray-900 dark:text-white mb-3">Service Categories</h3>
            <div className="grid grid-cols-2 gap-3">
              <div className="p-3 bg-gradient-to-r from-primary-50 to-primary-100 dark:from-primary-900/20 dark:to-primary-800/20 rounded-lg">
                <div className="text-primary-600 dark:text-primary-400 text-sm font-medium">Child Care</div>
                <div className="text-xs text-primary-600/80 dark:text-primary-400/80">652 active bookings</div>
              </div>
              <div className="p-3 bg-gradient-to-r from-secondary-50 to-secondary-100 dark:from-secondary-900/20 dark:to-secondary-800/20 rounded-lg">
                <div className="text-secondary-600 dark:text-secondary-400 text-sm font-medium">Elderly Care</div>
                <div className="text-xs text-secondary-600/80 dark:text-secondary-400/80">490 active bookings</div>
              </div>
              <div className="p-3 bg-gradient-to-r from-success-50 to-success-100 dark:from-success-900/20 dark:to-success-800/20 rounded-lg">
                <div className="text-success-600 dark:text-success-400 text-sm font-medium">Special Needs</div>
                <div className="text-xs text-success-600/80 dark:text-success-400/80">156 active bookings</div>
              </div>
              <div className="p-3 bg-gradient-to-r from-warning-50 to-warning-100 dark:from-warning-900/20 dark:to-warning-800/20 rounded-lg">
                <div className="text-warning-600 dark:text-warning-400 text-sm font-medium">Companion Care</div>
                <div className="text-xs text-warning-600/80 dark:text-warning-400/80">44 active bookings</div>
              </div>
            </div>
          </div>
        </div>
