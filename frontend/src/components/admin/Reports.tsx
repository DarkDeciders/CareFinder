...
export default function Reports() {
  ...
  const [reports] = useState<Report[]>([
    { 
      ...
      type: 'Revenue', 
      status: 'Generated',
      description: 'Detailed revenue analysis including bookings, commissions, and refunds',
      period: 'August 2025',
      frequency: 'Monthly',
      generatedBy: 'System',
      fileSize: '2.4 MB',
    ...
    { 
      ...
      type: 'Activity', 
      status: 'Generated',
      description: 'User engagement metrics, active users, and platform usage statistics',
      period: 'Last 30 days',
      frequency: 'Monthly',
      generatedBy: 'System',
      fileSize: '1.8 MB',
    ...
    { 
      ...
      type: 'Dispute', 
      status: 'Pending',
      description: 'Overview of customer disputes, resolutions, and pending cases',
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <div className="text-xs text-gray-500 dark:text-gray-400">{report.period} • {report.frequency}</div>
                      </div>
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-900 dark:text-white">{report.type}</div>
                    <div className="text-xs text-gray-500 dark:text-gray-400">By {report.generatedBy}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-900 dark:text-white">{report.date}</div>
                    <div className="text-xs text-gray-500 dark:text-gray-400">{report.fileSize}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
