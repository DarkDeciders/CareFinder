                ...
                >
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        <div className="text-sm font-medium text-gray-900 dark:text-white">{booking.family}</div>
                        <div className="text-xs text-gray-500 dark:text-gray-400">{booking.location}</div>
                      </div>
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-900 dark:text-white">{booking.caregiver}</div>
                    <div className="text-xs text-gray-500 dark:text-gray-400">{booking.notes}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-900 dark:text-white">{booking.date}</div>
                    <div className="text-xs text-gray-500 dark:text-gray-400">{booking.time} • {booking.duration}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
        ...
        {sortedBookings.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
              {searchTerm ? 'Try adjusting your search terms.' : 'New bookings will appear here.'}
            </p>
          </div>
        )}
      </div>
