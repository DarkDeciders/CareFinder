...
export default function AgentControl() {
  ...
  const forceAssignment = (assignmentId: string, agentId: string) => {
    console.log(
      `Force assigning assignment ${assignmentId} to agent ${agentId}`,
    );
              ...
              {agents.map((agent) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <div className="text-xs text-gray-500 dark:text-gray-400">
                      Location: {agent.location.lat.toFixed(4)},{" "}
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <div className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                      {agent.maxCapacity - agent.currentAssignments} slots
                      available
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                    <div className="flex space-x-2">
                      ...
                      <button
                        ...
                        disabled={
                          agent.status !== "active" ||
                          agent.currentAssignments >= agent.maxCapacity
                        }
                      >
                        Assign
                      </button>
                  ...
                  {agents
                    ...
                    .map((agent) => (
                      <option key={agent.id} value={agent.id}>
                        {agent.name} - {agent.zone} ({agent.currentAssignments}/
                        {agent.maxCapacity})
                      </option>
                    ))}
                </select>
                ...
                <div className="flex">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-yellow-700 dark:text-yellow-300">
                      This will override the automatic assignment algorithm.
                      Agent capacity and location will not be considered.
                    </p>
                  </div>
                </div>
              </div>
