        ...
        return (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                  Booking Cancellation Window (hours)
                </label>
                <input
                  type="number"
                  min="0"
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-300">
                    Mandatory background verification for caregivers
                  </p>
                </div>
                <input
                  type="checkbox"
              ...
              <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-300">
                    Mandatory reference verification for caregivers
                  </p>
                </div>
                <input
                  type="checkbox"
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              {Object.entries(settings.notifications).map(([key, value]) => (
                <div
                  key={key}
                  className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg"
                >
              ...
              {Object.entries(settings.content).map(([key, value]) => (
                <div key={key}>
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      handleSettingChange("content", key, e.target.value)
                    }
                    rows={6}
