        ...
        <div className="flex items-center justify-between">
          ...
          <div className="text-right">
            ...
            <div className="text-lg font-semibold text-gray-900 dark:text-white">
              {assignments.find((a) => a.status === "next")?.time ||
                "No upcoming"}
            </div>
          </div>
        </div>
                    ...
                    <div>
                      ...
                      <div className="flex items-center space-x-3 mt-1">
                        <span className="text-xs text-gray-500 dark:text-gray-400">
                          ...
                          {assignment.estimatedTravel} min
                        </span>
                        <span
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center">
            <div className="p-4 bg-primary-100 dark:bg-primary-900/20 rounded-lg mb-3">
              <svg
                className="w-8 h-8 text-primary-600 dark:text-primary-400 mx-auto"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
          ...
          <div className="text-center">
            <div className="p-4 bg-success-100 dark:bg-success-900/20 rounded-lg mb-3">
              <svg
                className="w-8 h-8 text-success-600 dark:text-success-400 mx-auto"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">
              Contact family before arrival or for verification
            </p>
          ...
          <div className="text-center">
            <div className="p-4 bg-warning-100 dark:bg-warning-900/20 rounded-lg mb-3">
              <svg
                className="w-8 h-8 text-warning-600 dark:text-warning-400 mx-auto"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">
              Report navigation problems or delays
            </p>
