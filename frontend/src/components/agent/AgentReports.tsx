...
export default function AgentReports() {
  ...
  const reports = [
    ...
    },
    {
      ...
      notes: 'Observed minor cleanliness issues in elderly care area. Caregiver communication with family needs improvement. Recommended additional training.'
    },
    {
      id: 3,
      type: 'incident',
      ...
      notes: 'Minor incident - child fell while playing. Caregiver responded appropriately with first aid and contacted parents immediately. No serious injury.'
    }
  ];
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-2xl p-6 border border-gray-200/50 dark:border-gray-700/50 text-center">
          ...
          <div className="text-sm text-gray-600 dark:text-gray-400">Reports This Week</div>
        </div>
        <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-2xl p-6 border border-gray-200/50 dark:border-gray-700/50 text-center">
          <div className="text-3xl font-bold text-success-600 dark:text-success-400">1</div>
          <div className="text-sm text-gray-600 dark:text-gray-400">Satisfactory Results</div>
        </div>
        <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-2xl p-6 border border-gray-200/50 dark:border-gray-700/50 text-center">
        ...
        <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-2xl p-6 border border-gray-200/50 dark:border-gray-700/50 text-center">
          <div className="text-3xl font-bold text-secondary-600 dark:text-secondary-400">97%</div>
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-gray-600">
              {reports.map((report) => (
                <tr key={report.id} className="hover:bg-gray-50/50 dark:hover:bg-gray-700/50">
                    ...
                    <div>
                      <div className="text-sm font-medium text-gray-900 dark:text-white">
                        {report.type === 'verification' ? 'Verification Report' :
                         report.type === 'quality_issue' ? 'Quality Issue Report' : 'Incident Report'}
                      </div>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-900 dark:text-white">{report.assignmentId}</div>
                    <div className="text-sm text-gray-600 dark:text-gray-400">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <div className="text-sm text-gray-600 dark:text-gray-400">{report.time}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${getResultColor(report.result)}`}>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 max-w-2xl w-full max-h-[80vh] overflow-y-auto">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Assignment ID</label>
                  <p className="text-sm text-gray-900 dark:text-white">{selectedReport.assignmentId}</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-900 dark:text-white">{selectedReport.family}</p>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Caregiver</label>
                  <p className="text-sm text-gray-900 dark:text-white">{selectedReport.caregiver}</p>
                </div>
              </div>

              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Report Notes</label>
                <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                  <p className="text-sm text-gray-900 dark:text-white">{selectedReport.notes}</p>
                </div>
              </div>
          ...
          {newReportType === 'quality_issue' && (
            <div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                {['Cleanliness', 'Communication', 'Punctuality', 'Safety', 'Professionalism', 'Other'].map((issue) => (
