    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center space-y-3 sm:space-y-0">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-2 sm:space-y-0 sm:space-x-2">
          <div className="bg-success-100 dark:bg-success-900/20 px-3 py-1 rounded-full">
            <span className="text-success-700 dark:text-success-400 text-xs sm:text-sm font-medium">
              Active Agent
            </span>
          </div>
          <div className="bg-primary-100 dark:bg-primary-900/20 px-3 py-1 rounded-full">
            <span className="text-primary-700 dark:text-primary-400 text-xs sm:text-sm font-medium">
      ...
      <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-gray-200/50 dark:border-gray-700/50">
        ...
        <div className="space-y-3 sm:space-y-4">
          {[
            ...
            <div
              key={assignment.id}
              className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-3 sm:p-4 bg-gray-50/50 dark:bg-gray-700/50 rounded-lg space-y-3 sm:space-y-0"
            >
              <div className="flex items-start sm:items-center space-x-3 sm:space-x-4 flex-1 min-w-0">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400 break-words">
                    {assignment.address} • {assignment.family} • Caregiver:{" "}
      ...
      <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-gray-200/50 dark:border-gray-700/50">
        ...
        <div className="space-y-3">
          {[
            {
              action: "Completed verification at The Perera Family",
              time: "30 minutes ago",
              type: "success",
            },
            {
              action: "Submitted quality assurance report for Emma Williams",
              time: "2 hours ago",
              type: "info",
            },
            {
              action: "Started route to The Silva Family residence",
              time: "3 hours ago",
              type: "warning",
            },
            {
              action: "Received new assignment for Central Colombo zone",
              time: "5 hours ago",
              type: "info",
            },
          ].map((item, index) => (
            <div
              key={index}
              className="flex items-start space-x-3 p-3 bg-gray-50/50 dark:bg-gray-700/50 rounded-lg"
            >
              <div
