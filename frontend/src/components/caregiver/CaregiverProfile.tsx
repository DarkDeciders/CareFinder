...
export default function CaregiverProfile() {
  ...
  const [formData, setFormData] = useState({
    ...
    certifications: [
      { name: 'First Aid Certificate', issuer: 'Red Cross Sri Lanka', expiry: '2025-12-31' },
      { name: 'Child Development Course', issuer: 'University of Colombo', expiry: 'No Expiry' }
    ],
    references: [
      { name: 'Dr. Priya Fernando', phone: '+94 77 111 2222', relationship: 'Previous Employer' },
      { name: 'Mrs. Kamala Perera', phone: '+94 77 333 4444', relationship: 'Family Friend' }
    ]
  });
  ...
  const handleAvailabilityChange = (day: string, available: boolean) => {
    setFormData(prev => ({
      ...
      availability: {
        ...prev.availability,
        [day]: { ...prev.availability[day as keyof typeof prev.availability], available }
      }
    }));
  };
  ...
  const addCertification = () => {
    setFormData(prev => ({
      ...prev,
      certifications: [...prev.certifications, { name: '', issuer: '', expiry: '' }]
    }));
  };
  ...
  const languageOptions = ['English', 'Sinhala', 'Tamil', 'Hindi', 'Portuguese', 'Mandarin'];

  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Caregiver Profile</h2>
        <button
      ...
      <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-2xl p-6 border border-gray-200/50 dark:border-gray-700/50">
        <div className="flex items-center space-x-6 mb-6">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-300">Professional Caregiver</p>
            <div className="flex items-center mt-2">
              <span className="text-yellow-500">★★★★★</span>
              <span className="text-sm text-gray-600 dark:text-gray-300 ml-2">4.9 (127 reviews)</span>
            </div>
            {isEditing && (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 bg-success-50 dark:bg-success-900/20 rounded-lg">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-sm font-medium text-success-800 dark:text-success-300">Identity Verified</span>
          </div>
          <div className="flex items-center space-x-2">
            <span className="text-success-600 dark:text-success-400">✓</span>
            <span className="text-sm font-medium text-success-800 dark:text-success-300">Background Checked</span>
          </div>
          <div className="flex items-center space-x-2">
            <span className="text-success-600 dark:text-success-400">✓</span>
            <span className="text-sm font-medium text-success-800 dark:text-success-300">References Verified</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-2xl p-6 border border-gray-200/50 dark:border-gray-700/50">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">NIC Number</label>
            {isEditing ? (
              <input
                type="text"
                value={formData.nic}
          ...
          <div>
            ...
            {isEditing ? (
              ...
              <p className="text-gray-900 dark:text-white">{new Date(formData.dateOfBirth).toLocaleDateString()}</p>
            )}
          </div>
          ...
          <div>
            ...
            {isEditing ? (
              ...
              <p className="text-gray-900 dark:text-white">{formData.experience} years</p>
            )}
          </div>
      ...
      <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-2xl p-6 border border-gray-200/50 dark:border-gray-700/50">
        ...
        <div className="space-y-6">
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Hourly Rate (LKR)</label>
            {isEditing ? (
              <input
                type="number"
              ...
              <p className="text-gray-900 dark:text-white">LKR {formData.hourlyRate}/hour</p>
            )}
          </div>
              ...
              {serviceOptions.map((service) => (
                <div key={service.key} className="flex items-center">
                  <input
                    ...
                    onChange={() => isEditing && handleServiceToggle(service.key)}
                    disabled={!isEditing}
                    className="w-4 h-4 text-primary-600 bg-gray-100 border-gray-300 rounded focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                  />
                  <label htmlFor={service.key} className="ml-2 text-sm text-gray-700 dark:text-gray-300">
                    {service.label}
                  </label>
                </div>
              ))}
              ...
              {languageOptions.map((language) => (
                <div key={language} className="flex items-center">
                  <input
                    ...
                    className="w-4 h-4 text-primary-600 bg-gray-100 border-gray-300 rounded focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                  />
                  <label htmlFor={language} className="ml-2 text-sm text-gray-700 dark:text-gray-300">
                    {language}
                  </label>
                </div>
              ))}
      ...
      <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-2xl p-6 border border-gray-200/50 dark:border-gray-700/50">
        ...
        <div className="space-y-3">
          {Object.entries(formData.availability).map(([day, schedule]) => (
            <div key={day} className="flex items-center justify-between p-3 border border-gray-200 dark:border-gray-600 rounded-lg">
              <div className="flex items-center space-x-3">
                <input
                  type="checkbox"
                  checked={schedule.available}
                  onChange={(e) => isEditing && handleAvailabilityChange(day, e.target.checked)}
                  disabled={!isEditing}
              ...
              <div className="text-sm text-gray-600 dark:text-gray-300">
                {schedule.available ? (schedule.times.join(', ') || '9:00-17:00') : 'Not available'}
              </div>
            </div>
          ))}
        </div>
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <p className="text-gray-900 dark:text-white text-sm">{cert.name}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <p className="text-gray-900 dark:text-white text-sm">{cert.issuer}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <p className="text-gray-900 dark:text-white text-sm">{cert.expiry}</p>
                  )}
                </div>
              </div>
            </div>
      ...
      <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-2xl p-6 border border-gray-200/50 dark:border-gray-700/50">
        ...
        <div className="space-y-4">
          {formData.references.map((ref, index) => (
            <div key={index} className="border border-gray-200 dark:border-gray-600 rounded-lg p-4">
              <div className="flex justify-between items-start mb-3">
                <h4 className="font-medium text-gray-900 dark:text-white">Reference {index + 1}</h4>
                {isEditing && (
                  <button
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <p className="text-gray-900 dark:text-white text-sm">{ref.name}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <p className="text-gray-900 dark:text-white text-sm">{ref.phone}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <p className="text-gray-900 dark:text-white text-sm">{ref.relationship}</p>
                  )}
                </div>
              </div>
            </div>
