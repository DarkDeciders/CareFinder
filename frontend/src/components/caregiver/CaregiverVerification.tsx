  ...
  const agentVisits = [
    {
      ...
      duration: 30,
      notes:
        "Excellent care standards observed. Child appeared happy and well-cared for. No issues identified.",
      rating: 5,
      issues: [],
    },
    {
      ...
      duration: 45,
      notes:
        "Minor improvements needed in medication management documentation. Overall care quality is good.",
      rating: 4,
    ...
    },
    {
      ...
      duration: 25,
      notes:
        "Outstanding care delivery. Patient comfort and safety protocols perfectly followed.",
      rating: 5,
      issues: [],
    },
  ];
        ...
        <div className="flex items-start space-x-3">
          ...
          <div>
            ...
            <p className="text-sm text-blue-800 dark:text-blue-300">
              CareFinder agents conduct regular quality assurance visits to
              ensure the highest standards of care. These visits help maintain
              service quality and provide valuable feedback for continuous
              improvement.
            </p>
            <ul className="text-xs text-blue-700 dark:text-blue-400 mt-2 list-disc list-inside">
              <li>
                Visits are scheduled based on service frequency and client needs
              </li>
              <li>
                Agents verify care quality, safety protocols, and client
                satisfaction
              </li>
              <li>
                Feedback is provided to help improve your service delivery
              </li>
            </ul>
          </div>
        </div>
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-gray-600">
              {agentVisits.map((visit) => (
                ...
                >
                    ...
                    <div>
                      ...
                      {visit.completedDate && (
                        <div className="text-xs text-success-600 dark:text-success-400">
                          Completed:{" "}
                          {new Date(visit.completedDate).toLocaleTimeString(
                            [],
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span
                      className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${getStatusColor(visit.status)}`}
                    >
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    {visit.result ? (
                      <div>
                        <span
                          className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${getResultColor(visit.result)}`}
                        >
                          {visit.result === "excellent"
                            ? "Excellent"
                            : visit.result === "satisfactory"
                              ? "Satisfactory"
                              : visit.result === "needs_improvement"
                                ? "Needs Improvement"
                                : "Unsatisfactory"}
                        </span>
                        {visit.rating && (
              ...
              {selectedVisit.result && (
                <div>
                  ...
                  <div className="flex items-center space-x-3">
                    <span
                      className={`inline-flex px-3 py-1 text-sm font-semibold rounded-full ${getResultColor(selectedVisit.result)}`}
                    >
                      {selectedVisit.result === "excellent"
                        ? "Excellent"
                        : selectedVisit.result === "satisfactory"
                          ? "Satisfactory"
                          : selectedVisit.result === "needs_improvement"
                            ? "Needs Improvement"
                            : "Unsatisfactory"}
                    </span>
            ...
            <div className="flex">
              ...
              <div>
                ...
                <ul className="text-sm text-yellow-700 dark:text-yellow-300 mt-2 list-disc list-inside">
                  <li>
                    Focus on improving medication management documentation
                  </li>
                  <li>
                    Consider attending additional training sessions on record
                    keeping
                  </li>
