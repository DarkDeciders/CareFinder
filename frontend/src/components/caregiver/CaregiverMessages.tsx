...
const chatHistory: Record<number, Message[]> = {
  1: [
    {
      sender: "family",
      text: "Hi Maria, just wanted to confirm you are still available for tomorrow at 10 AM?",
    },
  ...
  2: [
    ...
    {
      sender: "family",
      text: "Mr. Fernando mentioned you were fantastic with Dad.",
    },
    {
      sender: "me",
      text: "I appreciate that. I try to make sure they feel comfortable.",
    },
    { sender: "family", text: "Could you come again next Tuesday morning?" },
    { sender: "me", text: "Yes, I have availability between 9 and 12." },
    {
      sender: "family",
      text: "Perfect. We will book 9:30 then. Thanks Maria!",
    },
  ],
  3: [
    {
      sender: "family",
      text: "Hi, we received your application. Can we schedule a brief call?",
    },
    { sender: "me", text: "Absolutely — I am available after 4 PM today." },
    {
      sender: "family",
      text: "Could we do 5 PM? It would be just a short call.",
    },
    {
      sender: "me",
      text: "5 PM works for me. Do you want my number or a video call?",
    },
    {
      sender: "family",
      text: "Phone is fine. We will call from +94 77 123 4567.",
    },
  ...
  return (
    <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-gray-200/50 dark:border-gray-700/50 min-h-[500px] sm:min-h-[600px] flex flex-col lg:flex-row">
            ...
            >
              ...
              <div className="flex-1 overflow-hidden min-w-0">
                <div className="flex justify-between items-center">
                  <h3 className="font-semibold text-gray-800 dark:text-gray-200 truncate text-sm sm:text-base">
                    {convo.name}
                  </h3>
      ...
      <div className="w-full lg:w-2/3 flex flex-col min-h-0 flex-1">
        ...
        <div
          ref={scrollRef}
          className="flex-1 p-3 sm:p-4 lg:p-6 space-y-3 sm:space-y-4 overflow-y-auto min-h-0"
        >
        ...
        <div className="p-3 sm:p-4 border-t border-gray-200 dark:border-gray-700 flex-shrink-0">
          <div className="relative">
            ...
            <button
              ...
              className="absolute right-1 sm:right-2 top-1/2 -translate-y-1/2 bg-primary-600 hover:bg-primary-700 text-white rounded-full p-2 sm:p-2.5"
            >
              <svg
...
function TypingDots() {
  return (
    <div className="flex items-center space-x-1 px-2">
      <span
        className="w-2 h-2 rounded-full bg-gray-500/80 animate-bounce"
