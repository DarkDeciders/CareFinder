...
const overviewData = {
  ...
  upcomingJobs: [
    ...
    {
      id: 3,
      familyName: "The De Silva Family",
      service: "Tutoring",
      date: "2025-09-22",
  ...
  recentReviews: [
    {
      ...
      rating: 5,
      comment:
        "Maria is wonderful with our children. Always punctual and professional.",
    },
    {
      id: 2,
      familyName: "Mrs. Fernando",
      rating: 5,
      comment:
        "She has been a great help in caring for my mother. Highly recommended.",
    },
  ],
};
...
const StatCard = ({
  ...
  <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-5 border border-gray-200/50 dark:border-gray-700/50 flex items-start space-x-3 sm:space-x-4">
    ...
    <div className="min-w-0">
      ...
      <p className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 dark:text-white break-words">
        {value}
      </p>
    </div>
  </div>
        ...
        <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-gray-200/50 dark:border-gray-700/50">
          ...
          <ul className="space-y-3 sm:space-y-4">
            {overviewData.upcomingJobs.map((job) => (
              <li
                key={job.id}
                className="p-3 sm:p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg flex flex-col sm:flex-row sm:justify-between sm:items-center space-y-2 sm:space-y-0"
              >
                <div className="min-w-0">
          ...
          <ul className="space-y-3 sm:space-y-4">
            {overviewData.recentReviews.map((review) => (
              ...
              >
                ...
                <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 italic leading-relaxed">
                  &quot;{review.comment}&quot;
                </p>
              </li>
            ))}
