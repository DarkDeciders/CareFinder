          ...
          <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-2xl p-6 border border-gray-200/50 dark:border-gray-700/50">
            ...
            <div className="space-y-4">
              {trainees.map((trainee) => (
                <div
                  key={trainee.id}
                  className="p-4 bg-gray-50/50 dark:bg-gray-700/50 rounded-lg"
                >
                  ...
                  <div className="flex justify-between items-center mt-2">
                    <span className="text-xs text-gray-500 dark:text-gray-400">
                      {trainee.modules.filter((m) => m.completed).length}/
                      {trainee.modules.length} modules completed
                    </span>
                    <button
                ...
                <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-3">
                  <div
                    className={`h-3 rounded-full ${
                      selectedTraineeData.progress >= 80
                        ? "bg-success-500"
                        : selectedTraineeData.progress >= 50
                          ? "bg-warning-500"
                          : "bg-primary-500"
                    }`}
