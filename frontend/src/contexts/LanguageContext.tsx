...
const translations = {
  en: {
    ...
    'hero.subtitle': 'Connect with verified caregivers for childcare, elderly care, and special needs support. Safe, reliable, and professional care solutions for your family.',
    ...
    'services.comprehensive.subtitle': 'Professional care solutions tailored to your family\'s unique needs',
    'services.childcare.title': 'Childcare',
    'services.childcare.desc': 'Professional babysitters and nannies for your children',
    ...
    'services.special.desc': 'Specialized support for individuals with unique requirements',
    ...
    'features.verified.desc': 'All caregivers undergo background checks and verification',
    ...
    'features.secure.desc': 'Safe and secure payment processing with escrow protection',
    'features.support.title': '24/7 Support',
    'features.support.desc': 'Round-the-clock customer support when you need it',
    ...
    'works.step1.desc': 'Browse verified caregivers in your area. Filter by services, experience, ratings, and availability to find the perfect match.',
    'works.step2': 'Connect & Book',
    'works.step2.desc': 'Message caregivers directly, review their profiles and references, then book services that fit your schedule and budget.',
    'works.step3': 'Enjoy Peace of Mind',
    'works.step3.desc': 'Receive quality care with secure payments, real-time updates, and 24/7 support. Rate your experience to help our community.',

    // Safety section
    'safety.title': 'Your Safety is Our Priority',
    'safety.subtitle': 'Every caregiver goes through our comprehensive 3-tier verification system: document verification, skills training, and ongoing service quality monitoring.',
    'safety.doc.title': 'Document Verification',
    'safety.doc.desc': 'Police clearance certificates, educational credentials, and comprehensive identity verification for all caregivers.',
    'safety.payment.title': 'Secure Payments',
    'safety.payment.desc': 'Protected payments with escrow services and secure transaction processing through PayHere.',
    'safety.quality.title': 'Quality Assurance',
    'safety.quality.desc': 'Regular on-site visits by quality agents to ensure service standards and continuous improvement.',
    ...
    'cta.subtitle': 'Join thousands of families who trust CareFinder for their care needs. Get started today and experience the peace of mind you deserve.',
  ...
  si: {
    ...
    'hero.subtitle': 'ළමා සත්කාරය, වැඩිහිටි සත්කාරය සහ විශේෂ අවශ්‍යතා සහාය සඳහා සත්‍යාපිත සත්කාරකයන් සමඟ සම්බන්ධ වන්න. ඔබේ පවුල සඳහා ආරක්ෂිත, විශ්වසනීය සහ වෘත්තීය සත්කාර විසඳුම්.',
    ...
    'services.comprehensive.subtitle': 'ඔබේ පවුලේ අද්විතීය අවශ්‍යතාවන්ට ගැලපුම් කරන ලද වෘත්තීය සත්කාර විසඳුම්',
    ...
    'services.special.desc': 'අද්විතීය අවශ්‍යතා ඇති පුද්ගලයන් සඳහා විශේෂිත සහාය',
    ...
    'features.verified.desc': 'සියලුම සත්කාරකයන් පසුබිම් පරීක්ෂණ සහ සත්‍යාපනයට ලක් වේ',
    'features.quality.title': 'ගුණාත්මකභාව සහතිකය',
    'features.quality.desc': 'අපගේ පුහුණු නියෝජිතයන් විසින් පරිශ්‍රයේ ගුණාත්මක පරීක්ෂණ',
    'features.secure.title': 'ආරක්ෂිත ගෙවීම්',
    'features.secure.desc': 'එස්ක්‍රෝ ආරක්ෂණය සමඟ ආරක්ෂිත ගෙවීම් ක්‍රියාකාරිත්වය',
    ...
    'works.step1.desc': 'ඔබේ ප්‍රදේශයේ සත්‍යාපිත සත්කාරකයන් පිරික්සන්න. පරිපූර්ණ ගැලපීම සොයා ගැනීමට සේවාවන්, අත්දැකීම්, ශ්‍රේණිගත කිරීම් සහ ලබා ගත හැකි බව අනුව පෙරහන් කරන්න.',
    'works.step2': 'සම්බන්ධ වී වෙන්කරවා ගන්න',
    'works.step2.desc': 'සත්කාරකයන් සමඟ සෘජුව පණිවිඩ කරන්න, ඔවුන්ගේ පැතිකඩ සහ යොමු කිරීම් සමාලෝචනය කරන්න, පසුව ඔබේ කාලසටහනට සහ අයවැයට ගැලපෙන සේවාවන් වෙන්කරවා ගන්න.',
    'works.step3': 'මානසික සාමය භුක්ති විඳින්න',
    'works.step3.desc': 'ආරක්ෂිත ගෙවීම්, තත්‍ය කාලීන යාවත්කාලීන කිරීම් සහ 24/7 සහාය සමඟ ගුණාත්මක සත්කාරයක් ලබා ගන්න. අපගේ ප්‍රජාවට උදව් වීමට ඔබේ අත්දැකීම ශ්‍රේණිගත කරන්න.',

    // Safety section
    'safety.title': 'ඔබේ ආරක්ෂාව අපගේ ප්‍රමුඛතාවයයි',
    'safety.subtitle': 'සෑම සත්කාරකයෙකුම අපගේ සවිස්තරාත්මක 3-ස්ථර සත්‍යාපන පද්ධතිය හරහා ගමන් කරයි: ලේඛන සත්‍යාපනය, කුසලතා පුහුණුව සහ අඛණ්ඩ සේවා ගුණාත්මකභාව අධීක්ෂණය.',
    'safety.doc.title': 'ලේඛන සත්‍යාපනය',
    'safety.doc.desc': 'සියලුම සත්කාරකයන් සඳහා පොලිස් නිදහස් කිරීමේ සහතික, අධ්‍යාපනික අක්තපත්‍ර සහ සවිස්තරාත්මක අනන්‍යතා සත්‍යාපනය.',
    'safety.payment.title': 'ආරක්ෂිත ගෙවීම්',
    'safety.payment.desc': 'PayHere හරහා එස්ක්‍රෝ සේවාවන් සහ ආරක්ෂිත ගනුදෙනු ක්‍රියාකාරිත්වය සමඟ ආරක්ෂිත ගෙවීම්.',
    'safety.quality.title': 'ගුණාත්මකභාව සහතිකය',
    'safety.quality.desc': 'සේවා ප්‍රමිතීන් සහ අඛණ්ඩ වැඩිදියුණු කිරීම සහතික කිරීම සඳහා ගුණාත්මක නියෝජිතයන් විසින් නිතිපතා ස්ථානීය සංචාර.',
    ...
    'cta.subtitle': 'ඔවුන්ගේ සත්කාර අවශ්‍යතා සඳහා CareFinder විශ්වාස කරන දහස් ගණන් පවුල් සමඟ එක් වන්න. අද ආරම්භ කර ඔබ ලැබිය යුතු මානසික සාමය අත්විඳින්න.',
  ...
  ta: {
    ...
    'hero.subtitle': 'குழந்தை பராமரிப்பு, முதியோர் பராமரிப்பு மற்றும் சிறப்பு தேவைகள் ஆதரவிற்காக சரிபார்க்கப்பட்ட பராமரிப்பாளர்களுடன் இணைந்தொழுகுங்கள். உங்கள் குடும்பத்திற்கான பாதுகாப்பான, நம்பகமான மற்றும் தொழில்முறை பராமரிப்பு தீர்வுகள்.',
    ...
    'services.comprehensive.subtitle': 'உங்கள் குடும்பத்தின் தனித்துவமான தேவைகளுக்கு ஏற்ப வடிவமைக்கப்பட்ட தொழில்முறை பராமரிப்பு தீர்வுகள்',
    'services.childcare.title': 'குழந்தை பராமரிப்பு',
    'services.childcare.desc': 'உங்கள் குழந்தைகளுக்கான தொழில்முறை குழந்தை பராமரிப்பு',
    ...
    'services.special.desc': 'தனித்துவமான தேவைகள் உள்ள நபர்களுக்கான சிறப்பு ஆதரவு',
    ...
    'features.verified.desc': 'அனைத்து பராமரிப்பாளர்களும் பின்னணி சோதனைகள் மற்றும் சரிபார்ப்புக்கு உட்படுத்தப்படுகிறார்கள்',
    'features.quality.title': 'தர உத்தரவாதம்',
    'features.quality.desc': 'எங்கள் பயிற்சி பெற்ற முகவர்களால் தளத்தில் தர சோதனைகள்',
    'features.secure.title': 'பாதுகாப்பான கொடுப்பனவுகள்',
    'features.secure.desc': 'எஸ்க்ரோ பாதுகாப்புடன் பாதுகாப்பான கொடுப்பனவு செயலாக்கம்',
    'features.support.title': '24/7 ஆதரவு',
    'features.support.desc': 'உங்களுக்கு தேவைப்படும் போது 24 மணி நேர வாடிக்கையாளர் ஆதரவு',
    ...
    'footer.copyright': '© 2024 CareFinder. அனைத்து உரிமைகளும் பாதுகாக்கப்பட்டவை.',
    ...
    'started.step1.desc': 'உங்கள் அருகில் சரிபார்க்கப்பட்ட பராமரிப்பாளர்களைக் கண்டறியுங்கள்',
    ...
    'works.step1.desc': 'உங்கள் பகுதியில் சரிபார்க்கப்பட்ட பராமரிப்பாளர்களை உலாவுங்கள். சரியான பொருத்தத்தைக் கண்டறிய சேவைகள், அனுபவம், மதிப்பீடுகள் மற்றும் கிடைக்கும் தன்மை மூலம் வடிகட்டுங்கள்.',
    'works.step2': 'இணைந்து முன்பதிவு செய்யுங்கள்',
    'works.step2.desc': 'பராமரிப்பாளர்களுடன் நேரடியாக செய்தி அனுப்புங்கள், அவர்களின் விவரக்குறிப்புகள் மற்றும் குறிப்புகளை மதிப்பாய்வு செய்யுங்கள், பின்னர் உங்கள் அட்டவணை மற்றும் பட்ஜெட்டுக்கு ஏற்ற சேவைகளை முன்பதிவு செய்யுங்கள்.',
    'works.step3': 'மன அமைதியை அனுபவியுங்கள்',
    'works.step3.desc': 'பாதுகாப்பான கொடுப்பனவுகள், நிகழ்நேர புதுப்பிப்புகள் மற்றும் 24/7 ஆதரவுடன் தரமான பராமரிப்பைப் பெறுங்கள். எங்கள் சமூகத்திற்கு உதவ உங்கள் அனுபவத்தை மதிப்பிடுங்கள்.',

    // Safety section
    'safety.title': 'உங்கள் பாதுகாப்பு எங்கள் முன்னுரிமை',
    'safety.subtitle': 'ஒவ்வொரு பராமரிப்பாளரும் எங்கள் விரிவான 3-அடுக்கு சரிபார்ப்பு அமைப்பு வழியாக செல்கிறார்கள்: ஆவண சரிபார்ப்பு, திறன் பயிற்சி மற்றும் தொடர்ச்சியான சேவை தரக் கண்காணிப்பு.',
    'safety.doc.title': 'ஆவண சரிபார்ப்பு',
    'safety.doc.desc': 'அனைத்து பராமரிப்பாளர்களுக்கும் போலீஸ் அனுமதி சான்றிதழ்கள், கல்வி சான்றுகள் மற்றும் விரிவான அடையாள சரிபார்ப்பு.',
    'safety.payment.title': 'பாதுகாப்பான கொடுப்பனவுகள்',
    'safety.payment.desc': 'PayHere மூலம் எஸ்க்ரோ சேவைகள் மற்றும் பாதுகாப்பான பரிவர்த்தனை செயலாக்கத்துடன் பாதுகாக்கப்பட்ட கொடுப்பனவுகள்.',
    'safety.quality.title': 'தர உத்தரவாதம்',
    'safety.quality.desc': 'சேவை தரநிலைகள் மற்றும் தொடர்ச்சியான மேம்பாட்டை உறுதிப்படுத்த தர முகவர்களால் வழக்கமான தள வருகைகள்.',
    ...
    'cta.subtitle': 'அவர்களின் பராமரிப்பு தேவைகளுக்காக CareFinder ஐ நம்பும் ஆயிரக்கணக்கான குடும்பங்களுடன் சேருங்கள். இன்றே தொடங்கி நீங்கள் தகுதியான மன அமைதியை அனுபவியுங்கள்.',
...
export function LanguageProvider({ children }: LanguageProviderProps) {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      const savedLanguage = localStorage.getItem('carefinder-language') as Language;
