...
export default function ProfileScreen() {
  ...
  const handleEmergencyCall = (contact: any) => {
    Alert.alert("Emergency Call", `Call ${contact.name}?\n${contact.phone}`, [
      { text: "Cancel", style: "cancel" },
      {
        text: "Call",
        onPress: () => {
            ...
            <View className="flex-row justify-between items-center">
              ...
              {isEditing ? (
                <TextInput
                  ...
                  onChangeText={(text) =>
                    setProfileData({ ...profileData, zone: text })
                  }
                />
              ) : (
                <Text className="text-gray-800 font-medium">
            ...
            <View className="flex-row justify-between items-center">
              ...
              {isEditing ? (
                <TextInput
                  ...
                  onChangeText={(text) =>
                    setProfileData({ ...profileData, workingHours: text })
                  }
                />
              ) : (
                <Text className="text-gray-800 font-medium">
            ...
            <View className="flex-row justify-between items-center">
              ...
              {isEditing ? (
                <TextInput
                  ...
                  onChangeText={(text) =>
                    setProfileData({ ...profileData, licensePlate: text })
                  }
                />
              ) : (
                <Text className="text-gray-800 font-medium">
