          ...
          <View className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100">
            ...
            <View className="border-l-4 border-blue-500 pl-4 mb-4">
              ...
              <Text className="text-xs text-gray-500">
                Verification: Sarah Chen (Caregiver)
              </Text>
            </View>
            ...
            <View className="border-l-4 border-gray-300 pl-4 mb-4">
              ...
              <Text className="text-sm text-gray-600 mb-1">
                78 Bauddhaloka Mawatha, Colombo 07
              </Text>
              <Text className="text-xs text-gray-500">
          ...
          <View className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100">
            <View className="flex-row items-start mb-3">
              ...
              <View className="flex-1">
                ...
                <Text className="text-xs text-gray-600">
                  The Fernando Family - Emma Williams
                </Text>
            ...
            <View className="flex-row items-start">
              ...
              <View className="flex-1">
                ...
                <Text className="text-xs text-gray-600">
                  4 assignments planned for today
                </Text>
