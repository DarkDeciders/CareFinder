  ...
  return (
    <View className="flex-1 bg-gradient-to-br from-blue-500 to-teal-500 justify-center items-center">
      ...
      <View className="items-center mb-8">
        ...
        <Text className="text-xl font-semibold text-blue-100 mb-1">Agent App</Text>
      ...
      <View className="flex-row items-center mt-8">
        ...
        <View className="w-2 h-2 bg-white/70 rounded-full mr-1 animate-pulse" style={{animationDelay: '200ms'}}></View>
        <View className="w-2 h-2 bg-white/50 rounded-full animate-pulse" style={{animationDelay: '400ms'}}></View>
      </View>
